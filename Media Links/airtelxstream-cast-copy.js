...
(function() {
    ...
    // Get default copy settings from storage using StorageUtils
    async function getDefaultSettings() {
        const result = await StorageUtils.getSettings(
            ['defaultAirtelCastCount', 'defaultAirtelContentFormat', 'defaultAirtelOutputFormat'],
            { defaultAirtelCastCount: 5, defaultAirtelContentFormat: 'name-role', defaultAirtelOutputFormat: 'newline' }
        );
        return {
            count: result.defaultAirtelCastCount,
            content: result.defaultAirtelContentFormat,
            output: result.defaultAirtelOutputFormat
        };
    }
